...
export default function Libraries() {
  ...
  const filteredLibraries = libraries.filter((lib) => lib.title.toLowerCase().includes(searchTerm.toLowerCase()))
  const filteredAllLibraries = allLibraries.filter((lib) => lib.title.toLowerCase().includes(searchTerm.toLowerCase()))
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-10 mt-6">
        ...
        >
          <h2 className={`text-2xl font-bold mb-4 ${darkMode ? "text-[#BDD63B]" : "text-[#0B0E1D]"}`}>
          ...
          <form onSubmit={handleCreate} className="flex flex-col gap-4">
            ...
            <input
              ...
              accept="image/*"
              className={`p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#BDD63B] ${
                darkMode ? "bg-[#0B0E1D] text-white" : "bg-[#DDE7FF] text-[#0B0E1D]"
              }`}
            ...
            {filteredLibraries.map((lib) => (
              ...
              >
                <img
                  src={
                    lib.image_url ||
                    `${import.meta.env.VITE_API_BASE_URL || "http://localhost:8000"}/static/default_library.png`
                  }
                  alt={lib.title}
      ...
      <h2 className={`pt-6 text-2xl font-bold mb-4 ${darkMode ? "text-[#BDD63B]" : "text-[#0B0E1D]"}`}>
        ALL LIBRARIES
      </h2>
